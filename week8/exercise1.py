...
def string_please() -> str:
    ...
    string_please = 'Returns a string, anything you like.'
...
def dictionary_please() -> dict:
    ...
    dictionary_please = {"Age": "10" , "Height": "120cm"}
...
def put_behind_bars(input_string="very naughty boy"):
    ...
    """
    put_behind_bars = list(input_string)
    my_list = "|".join(put_behind_bars)
    return "|" + my_list + "|"
...
def best_letter_for_pets():
    ...
    for letters in the_alphabet:
        x = len(pet_filter(letters))
        if x > longest:
            longest = x 
            popular_letter = letters
